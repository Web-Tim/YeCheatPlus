...
public class AxisAlignedBB {
    ...
    {
        Vec3D vec3 = vecA.getIntermediateWithXValueD(vecB, this.minX);
        Vec3D vec31 = vecA.getIntermediateWithXValueD(vecB, this.maxX);
        Vec3D vec32 = vecA.getIntermediateWithYValueD(vecB, this.minY);
        Vec3D vec33 = vecA.getIntermediateWithYValueD(vecB, this.maxY);
        Vec3D vec34 = vecA.getIntermediateWithZValueD(vecB, this.minZ);
        Vec3D vec35 = vecA.getIntermediateWithZValueD(vecB, this.maxZ);
        ...
        if (vec31 != null && (vec36 == null || vecA.squareDistanceToD(vec31) < vecA.squareDistanceToD(vec36)))
        {
            vec36 = vec31;
        }

        if (vec32 != null && (vec36 == null || vecA.squareDistanceToD(vec32) < vecA.squareDistanceToD(vec36)))
        {
            vec36 = vec32;
        }

        if (vec33 != null && (vec36 == null || vecA.squareDistanceToD(vec33) < vecA.squareDistanceToD(vec36)))
        {
            vec36 = vec33;
        }

        if (vec34 != null && (vec36 == null || vecA.squareDistanceToD(vec34) < vecA.squareDistanceToD(vec36)))
        {
            vec36 = vec34;
        }

        if (vec35 != null && (vec36 == null || vecA.squareDistanceToD(vec35) < vecA.squareDistanceToD(vec36)))
        {
            vec36 = vec35;
        }
    ...
    {
        return vec == null ? false : vec.b >= this.minY && vec.b <= this.maxY && vec.c >= this.minZ && vec.c <= this.maxZ;
    }
    ...
    {
        return vec == null ? false : vec.a >= this.minX && vec.a <= this.maxX && vec.c >= this.minZ && vec.c <= this.maxZ;
    }
    ...
    {
        return vec == null ? false : vec.a >= this.minX && vec.a <= this.maxX && vec.b >= this.minY && vec.b <= this.maxY;
    }
