...
/**
 * @author Mojang
 * This is copied from Minecraft 1.8.8
 */
public class Vec3 {
    ...
    public Vec3(Vector3i p_i46377_1_)
    {
    ...
    public double squareDistanceToD(Vec3D vec)
    {
        double d0 = vec.a - this.xCoord;
        double d1 = vec.b - this.yCoord;
        double d2 = vec.c - this.zCoord;
        return d0 * d0 + d1 * d1 + d2 * d2;
    }
     ...
     */
    public Vec3D getIntermediateWithXValueD(Vec3 vec, double x)
    {
        double d0 = vec.xCoord - this.xCoord;
        double d1 = vec.yCoord - this.yCoord;
        double d2 = vec.zCoord - this.zCoord;
    ...
    public Vec3D getIntermediateWithYValueD(Vec3 vec, double y)
    {
        double d0 = vec.xCoord - this.xCoord;
        double d1 = vec.yCoord - this.yCoord;
        double d2 = vec.zCoord - this.zCoord;
    ...
    public Vec3D getIntermediateWithZValueD(Vec3 vec, double z)
    {
        double d0 = vec.xCoord - this.xCoord;
        double d1 = vec.yCoord - this.yCoord;
        double d2 = vec.zCoord - this.zCoord;
    ...
    public Vec3 rotatePitch(float pitch)
    {
        ...
        double d1 = this.yCoord * (double)f + this.zCoord * f1;
        double d2 = this.zCoord * (double)f - this.yCoord * f1;
